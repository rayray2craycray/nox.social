...
grep "disableActivityIndicatorAutoHide" node_modules/expo-splash-screen/ios/SplashScreenManager.swift | grep -v "//" | grep -q "disableActivityIndicatorAutoHide" && echo "FAIL: splash patch missing (call still present)" || echo "Splash patch OK"
